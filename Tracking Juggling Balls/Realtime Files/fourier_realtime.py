...
def save_plots(signal, frame):
    ...
    ax1.grid(True)
    ax1.legend()
    fig1.savefig('plots/ball_y_positions.png')  # Save y-position plot
    ...
    ax2.grid(True)
    ax2.legend()
    fig2.savefig('plots/fourier_transform.png')  # Save Fourier Transform plot
...
while True:
    ...
    if current_position:
        ...
        time_steps.append(current_time)  # Use real elapsed time for the x-axis
    ...
    if len(y_positions) > 0:
        ...
        normalized_time_steps = [t - time_steps[0] for t in time_steps]

        # Update the y-position plot
        line1.set_xdata(normalized_time_steps)
        ...
        if len(y_positions) > 1:
            ...
            freqs = np.fft.fftfreq(len(y_data), normalized_time_steps[1] - normalized_time_steps[0])
