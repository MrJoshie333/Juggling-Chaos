...
# Function to save the figure on exit
def save_figure_on_exit():
    save_path = os.path.join(os.getcwd(), "plots/phase_space_plot.png")
    fig.savefig(save_path)
    print(f"Figure saved to {save_path}")

# Register the save function to run on exit
atexit.register(save_figure_on_exit)
